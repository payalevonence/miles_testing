...
view: median_asr {
  derived_table: {
    sql: SELECT
                ...
                END AS discharged
            FROM
                `natrion-operational-data.operational_data.pre_build_pouch` AS pre_build_pouch
            INNER JOIN
            ...
            INNER JOIN
                `natrion-operational-data.data.electrical_step_pouch` AS electrical_step_pouch ON pre_build_pouch.cell_id = electrical_step_pouch.Cell_id  ;;
  }
